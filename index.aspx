<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="CampusBookMarket.index" %>
...
<head runat="server">
    ...
    <style>
        ...
        * {
        ...
        /* Hero Section */
        .hero {
            background: linear-gradient(rgba(26, 86, 219, 0.8), rgba(26, 86, 219, 0.9)), url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80');
        ...
        .auction-card {
            background: linear-gradient(to bottom, #fff, #f1f8ff);
...
<body>
    ...
    <nav>
        <div class="logo">
            ...
            <span>Campus Essentials Market</span>
        </div>
        ...
        <div class="nav-actions">
            <asp:button class="btn btn-login" id="loginBtn" runat="server">Login</asp:button>
            <asp:button class="btn btn-register" id="registerBtn">Register runat="server"</asp:button>
    ...
    <footer>
        <div class="footer-section">
            <h3>Campus Essentials Market</h3>
            <p>Your one-stop shop for all university necessities. Quality products at student-friendly prices.</p>
        </div>
        ...
        <div class="footer-section">
            <h3>Contact Us</h3>
            <p>Email: nexfied@uj.com</p>
            <p>Phone: (555) 123-4567</p>
            <p>Address: 123 University Ave, College Town</p>
        </div>

        <div class="copyright">
            &copy; 2023 Campus Essentials Hub. All rights reserved.
        </div>
    </footer>
